...
include::chapters/extensions/metadata/current_extensions_appendix.adoc[]

include::chapters/extensions/metadata/provisional_extensions_appendix.adoc[]

include::chapters/extensions/metadata/deprecated_extensions_appendix.adoc[]
