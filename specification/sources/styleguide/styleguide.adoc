...
* <<design>> - an informative discussion of API design principles encouraged
  by the Specification Editor and the broader Working Group.
...
* 2025-04-08 - Update the XML schema used for extending interaction
  ...
  predicate.
* 2025-06-30 - Add an informative chapter on API design principles.
* 2025-10-23 - Bring extension guidelines up to date with current practice,
  including interface include, ordering, and possible example code.
* 2026-05-20 - In XML schema, allow deprecation expressions to be `+`
  delimited lists of extension names, and add an element to permit
  extensions to extend the list of valid return codes for a function.
