...
`main` branch of the GitHub `<<openxr-docs,KhronosGroup/OpenXR-Docs>>`
project and internal GitLab.
However, specifications generated from this branch will only include the
extension when the Makefile is invoked appropriately.
...
* Revision 1, 2019-07-12 (Ryan Pavlik)
...
* Revision 2, 2019-07-12 (Ryan Pavlik)
** ... etc. ...
----
--
+
