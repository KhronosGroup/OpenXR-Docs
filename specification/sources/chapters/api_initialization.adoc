...
include::{generated}/api/funcpointers/PFN_xrGetInstanceProcAddr.txt[]
...
include::{generated}/api/funcpointers/PFN_xrCreateApiLayerInstance.txt[]
...
include::{generated}/api/protos/xrNegotiateLoaderRuntimeInterface.txt[]
...
* the runtime does not support the interface versions supported by the
  loader as specified by the parameters
  slink:XrNegotiateLoaderInfo::pname:minInterfaceVersion and
  slink:XrNegotiateLoaderInfo::pname:maxInterfaceVersion
* the runtime does not support the API versions supported by the loader as
  specified by the parameters
  slink:XrNegotiateLoaderInfo::pname:minApiVersion and
  slink:XrNegotiateLoaderInfo::pname:maxApiVersion.
...
be between slink:XrNegotiateLoaderInfo::pname:minInterfaceVersion and
slink:XrNegotiateLoaderInfo::pname:maxInterfaceVersion.

The runtime must: set the
slink:XrNegotiateRuntimeRequest::pname:runtimeApiVersion with the API
version of OpenXR it will execute under.
The slink:XrNegotiateRuntimeRequest::pname:runtimeApiVersion set must: be
between slink:XrNegotiateLoaderInfo::pname:minApiVersion and
slink:XrNegotiateLoaderInfo::pname:maxApiVersion.
...
include::{generated}/validity/protos/xrNegotiateLoaderRuntimeInterface.txt[]
--
...
include::{generated}/api/structs/XrNegotiateLoaderInfo.txt[]
...
include::{generated}/validity/structs/XrNegotiateLoaderInfo.txt[]
--
...
include::{generated}/api/enums/XrLoaderInterfaceStructs.txt[]
...
--
include::{generated}/api/defines/XR_LOADER_INFO_STRUCT_VERSION.txt[]
...
--
include::{generated}/api/defines/XR_CURRENT_LOADER_RUNTIME_VERSION.txt[]
...
--
include::{generated}/api/defines/XR_CURRENT_LOADER_API_LAYER_VERSION.txt[]
...
include::{generated}/api/structs/XrNegotiateRuntimeRequest.txt[]
...
* pname:runtimeInterfaceVersion is the version of the runtime interface
  ...
  Must: not be outside of the bounds of the
  slink:XrNegotiateLoaderInfo::pname:minInterfaceVersion and
  slink:XrNegotiateLoaderInfo::pname:maxInterfaceVersion values (inclusive).
...
include::{generated}/validity/structs/XrNegotiateRuntimeRequest.txt[]
--
...
--
include::{generated}/api/defines/XR_RUNTIME_INFO_STRUCT_VERSION.txt[]
...
include::{generated}/api/protos/xrNegotiateLoaderApiLayerInterface.txt[]
...
* the API layer does not support the interface versions supported by the
  ...
  slink:XrNegotiateLoaderInfo::pname:minInterfaceVersion and
  slink:XrNegotiateLoaderInfo::pname:maxInterfaceVersion
* the API layer does not support the API versions supported by the loader as
  specified by the parameters
  slink:XrNegotiateLoaderInfo::pname:minApiVersion and
  slink:XrNegotiateLoaderInfo::pname:maxApiVersion.
...
The slink:XrNegotiateApiLayerRequest::pname:layerApiVersion set must: be
between slink:XrNegotiateLoaderInfo::pname:minApiVersion and
slink:XrNegotiateLoaderInfo::pname:maxApiVersion.
...
include::{generated}/validity/protos/xrNegotiateLoaderApiLayerInterface.txt[]
--
...
include::{generated}/api/structs/XrNegotiateApiLayerRequest.txt[]
...
include::{generated}/validity/structs/XrNegotiateApiLayerRequest.txt[]
--
...
--
include::{generated}/api/defines/XR_API_LAYER_INFO_STRUCT_VERSION.txt[]
...
include::{generated}/api/protos/xrCreateApiLayerInstance.txt[]
...
* The API layer must: then update its copy of the slink:XrApiLayerCreateInfo
  structure, setting
  slink:XrApiLayerCreateInfo::slink:XrApiLayerCreateInfo::pname:nextInfo to
  point to the slink:XrApiLayerNextInfo for the next API layer (e.g.
...
include::{generated}/validity/protos/xrCreateApiLayerInstance.txt[]
--
...
include::{generated}/api/structs/XrApiLayerCreateInfo.txt[]
...
include::{generated}/validity/structs/XrApiLayerCreateInfo.txt[]
--
...
--
include::{generated}/api/defines/XR_API_LAYER_CREATE_INFO_STRUCT_VERSION.txt[]
...
--
include::{generated}/api/defines/XR_API_LAYER_MAX_SETTINGS_PATH_SIZE.txt[]
...
include::{generated}/api/structs/XrApiLayerNextInfo.txt[]
...
include::{generated}/validity/structs/XrApiLayerNextInfo.txt[]
--
...
--
include::{generated}/api/defines/XR_API_LAYER_NEXT_INFO_STRUCT_VERSION.txt[]
