...
--
The slink:XrEventDataReferenceSpaceChangePending event structure is defined
as:
...
* pname:locations is an array of slink:XrSpaceLocations for the runtime to
  populate with the locations of the specified spaces in the
