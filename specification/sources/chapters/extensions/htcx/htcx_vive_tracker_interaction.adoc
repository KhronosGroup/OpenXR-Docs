...
include::../metadata/XR_HTCX_vive_tracker_interaction.adoc[]
...
include::{INCS-VAR}/api/structs/XrViveTrackerPathsHTCX.txt[]
...
include::{INCS-VAR}/validity/structs/XrViveTrackerPathsHTCX.txt[]
--
...
include::{INCS-VAR}/api/structs/XrEventDataViveTrackerConnectedHTCX.txt[]
...
include::{INCS-VAR}/validity/structs/XrEventDataViveTrackerConnectedHTCX.txt[]
--
...
include::{INCS-VAR}/api/protos/xrEnumerateViveTrackerPathsHTCX.txt[]
...
include::{INCS-VAR}/validity/protos/xrEnumerateViveTrackerPathsHTCX.txt[]
--
