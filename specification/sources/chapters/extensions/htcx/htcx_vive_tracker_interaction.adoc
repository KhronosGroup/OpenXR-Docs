...
XrPath suggestedBindingPath {XR_NULL_PATH};
...
XrInteractionProfileSuggestedBinding profileSuggBindings {
    ...
    .countSuggestedBindings = static_cast<uint32_t>(actionSuggBindings.size()),
    .suggestedBindings = actionSuggBindings.data(),
};
CHK_XR(xrSuggestInteractionProfileBindings(instance, &profileSuggBindings));

// Create action space for locating tracker
XrSpace chestTrackerSpace {XR_NULL_HANDLE};
XrActionSpaceCreateInfo actionSpaceInfo {
    .type = XR_TYPE_ACTION_SPACE_CREATE_INFO,
    .action = chestPoseAction,
    .subactionPath = chestTrackerRolePath,
};
