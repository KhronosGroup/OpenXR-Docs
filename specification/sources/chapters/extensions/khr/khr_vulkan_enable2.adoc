...
include::../meta/XR_KHR_vulkan_enable2.adoc[]
...
structure.
This section of the document describes the mechanisms this extensions
exposes to ensure the shared Vulkan queue is compatible with the runtime and
...
[open,refpage='XrVulkanInstanceCreateFlagsKHR',type='flags',desc='Vulkan Instance Create Info Flags',xrefs='XrVulkanInstanceCreateInfoKHR']
--
...
[open,refpage='XrVulkanDeviceCreateFlagsKHR',type='flags',desc='Vulkan Device Create Info Flags',xrefs='XrVulkanDeviceCreateInfoKHR']
--
...
Populating a slink:XrGraphicsBindingVulkan2KHR structure with a member that
does not meet the requirements outlined by this extension may: result in
undefined behaviour by the OpenXR runtime.
...
result in undefined behaviour in the OpenXR runtime.
...
* Having a memory layout compatible with
  ename:VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL for color images, or
  ename:VK_IMAGE_LAYOUT_DEPTH_STENCIAL_ATTACHMENT_OPTIMAL for depth images.
