...
Anchors created by an application via apiext:XR_ANDROID_trackables,
apiext:XR_EXT_spatial_anchor, and apiext:XR_ANDROID_spatial_anchor_space are
tied to a specific session and are thus not visible to other applications.
...
slink:XrSpace created previously by calling
flink:xrCreateAnchorSpaceANDROID, flink:xrCreatePersistedAnchorSpaceANDROID,
or flink:xrCreateSpatialAnchorSpaceANDROID.
