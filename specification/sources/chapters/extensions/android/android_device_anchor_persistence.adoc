...
The apiext:XR_ANDROID_device_anchor_persistence extension is now deprecated.
...
System support, persistence data loading, and enumeration of persisted
anchors is replaced by apiext:XR_EXT_spatial_persistence:

[width="100%",options="header"]
|====
| apiext:XR_ANDROID_device_anchor_persistence functionality | Now available in
| slink:XrSystemDeviceAnchorPersistencePropertiesANDROID & flink:xrEnumerateSupportedPersistenceAnchorTypesANDROID | flink:xrEnumerateSpatialPersistenceScopesEXT
| slink:XrDeviceAnchorPersistenceANDROID             | slink:XrSpatialPersistenceContextEXT
| flink:xrCreateDeviceAnchorPersistenceANDROID       | flink:xrCreateSpatialPersistenceContextAsyncEXT & flink:xrCreateSpatialPersistenceContextCompleteEXT
| flink:xrDestroyDeviceAnchorPersistenceANDROID      | flink:xrDestroySpatialPersistenceContextEXT
| flink:xrEnumeratePersistedAnchorsANDROID           | <<ext_spatial_persistence_discover_all_entities>>
|====

Functions to persist and unpersist anchors are replaced by
apiext:XR_EXT_spatial_persistence_operations:

[width="100%",options="header"]
|====
| apiext:XR_ANDROID_device_anchor_persistence functionality           | Now available in
| flink:xrPersistAnchorANDROID & flink:xrGetAnchorPersistStateANDROID | flink:xrPersistSpatialEntityAsyncEXT & flink:xrPersistSpatialEntityCompleteEXT
| flink:xrUnpersistAnchorANDROID                                      | flink:xrUnpersistSpatialEntityAsyncEXT & flink:xrUnpersistSpatialEntityCompleteEXT
|====

==== Inspect system capability

[open,refpage='XrSystemDeviceAnchorPersistencePropertiesANDROID',type='structs',desc='System property for anchor persistence',xrefs='XrSystemProperties']
--
