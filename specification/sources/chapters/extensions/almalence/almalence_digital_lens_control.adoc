...
--
include::{generated}/api/flags/XrDigitalLensControlFlagsALMALENCE.txt[]
--

[open,refpage='XrDigitalLensControlFlagBitsALMALENCE',type='enums',desc='XrDigitalLensControlFlagBitsALMALENCE']
--
include::{generated}/api/enums/XrDigitalLensControlFlagBitsALMALENCE.txt[]

include::{generated}/api/enums/XrDigitalLensControlFlagBitsALMALENCE.comments.txt[]
--
