...
.Flag Descriptions
****
* ename:XR_DIGITAL_LENS_CONTROL_PROCESSING_DISABLE_BIT_ALMALENCE disables
  Digital Lens processing of render textures.
...
* pname:flags is one or more elink:XrDigitalLensControlFlagBitsALMALENCE
  which indicate various characteristics desired for the Digital Lens.
