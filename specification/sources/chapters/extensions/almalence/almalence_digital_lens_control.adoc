...
This extension enables the handling of the Digital Lens for VR API Layer by calling flink:xrSetDigitalLensControlALMALENCE.
...
[open,refpage='xrSetDigitalLensControlALMALENCE',type='protos',desc='Handles DLVR state (ON\OFF)']
--
The flink:xrSetDigitalLensControlALMALENCE function is defined as:

include::../../../../generated/api/protos/xrSetDigitalLensControlALMALENCE.txt[]

.Parameter Descriptions
****
* pname:session is a handle to a running slink:XrSession. 
* pname:digitalLensControl is the slink:XrDigitalLensControlALMALENCE that contains desired characteristics for the Digital Lens

****

flink:xrSetDigitalLensControlALMALENCE handles state of Digital Lens API Layer

include::../../../../generated/validity/protos/xrSetDigitalLensControlALMALENCE.txt[]
--
