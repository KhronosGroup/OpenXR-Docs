...
include::../metadata/XR_VARJO_view_offset.adoc[]
...
include::{INCS-VAR}/api/protos/xrSetViewOffsetVARJO.txt[]
...
include::{INCS-VAR}/validity/protos/xrSetViewOffsetVARJO.txt[]
