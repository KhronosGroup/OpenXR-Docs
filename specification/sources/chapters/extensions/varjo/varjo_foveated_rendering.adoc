...
[open,refpage='XrSystemFoveatedRenderingPropertiesVARJO',type='structs',desc='System property for foveated rendering',xrefs='XrSystemProperties']
--
...
XrSystemProperties systemProperties {
  ...
  .next = &foveatedRenderingProperties,
};
...
if (foveatedRenderingProperties.supportsFoveatedRendering && viewConfigType == XR_VIEW_CONFIGURATION_TYPE_PRIMARY_QUAD_VARJO) {
  std::vector<XrFoveatedViewConfigurationViewVARJO> requestFoveatedConfig(4, {
    ...
    .next = nullptr,
    .foveatedRenderingActive = XR_TRUE,
  });
...
XrReferenceSpaceCreateInfo createViewSpaceInfo {
...
XrReferenceSpaceCreateInfo createReferenceSpaceInfo {
  .type = XR_TYPE_REFERENCE_SPACE_CREATE_INFO,
  .referenceSpaceType = XR_REFERENCE_SPACE_TYPE_COMBINED_EYE_VARJO,
  .poseInReferenceSpace = {
    .orientation = {
      .w = 1.0f,
    },
...
XrSpaceLocation renderGazeLocation {
...
XrViewLocateFoveatedRenderingVARJO viewLocateFoveatedRendering {
  ...
  .foveatedRenderingActive = foveationActive,
};

XrViewLocateInfo viewLocateInfo {
  .type = XR_TYPE_VIEW_LOCATE_INFO,
  .next = &viewLocateFoveatedRendering,
