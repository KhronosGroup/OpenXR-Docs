...
struct AppView : implements<AppView, IFrameworkView> {
    ...
    void Run() {
        ...
        XrHolographicWindowAttachmentMSFT holographicWindowAttachment {
            .type = XR_TYPE_ATTACHED_CORE_WINDOW_MSFT,
            .next = &graphicsBinding,
            .coreWindow = window.as<IUnknown>().get(),
            .holographicSpace = holographicSpace.as<IUnknown>().get(),
        };

        XrSessionCreateInfo sessionCreateInfo {
            .type = XR_TYPE_SESSION_CREATE_INFO,
            .next = &holographicWindowAttachment,
            .systemId = systemId,
        };
