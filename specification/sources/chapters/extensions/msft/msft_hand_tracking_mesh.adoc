...
[open,refpage='XrHandPoseTypeMSFT',type='enums',desc='Describe type of input hand pose',xrefs='XrHandPoseTypeMSFT XrHandTrackerCreateInfoEXT xrCreateHandTrackerEXT']
--
