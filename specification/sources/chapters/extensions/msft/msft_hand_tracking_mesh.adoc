...
include::{generated}/api/structs/XrSystemHandTrackingMeshPropertiesMSFT.adoc[]
...
include::{generated}/validity/structs/XrSystemHandTrackingMeshPropertiesMSFT.adoc[]
--
...
include::{generated}/api/protos/xrCreateHandMeshSpaceMSFT.adoc[]
...
slink:XrHandPoseTypeInfoMSFT::pname:handPoseType to
ename:XR_HAND_POSE_TYPE_REFERENCE_OPEN_PALM_MSFT.
...
include::{generated}/validity/protos/xrCreateHandMeshSpaceMSFT.adoc[]
--
...
--
include::{generated}/api/structs/XrHandMeshSpaceCreateInfoMSFT.adoc[]
...
include::{generated}/validity/structs/XrHandMeshSpaceCreateInfoMSFT.adoc[]
--
...
include::{generated}/api/protos/xrUpdateHandMeshMSFT.adoc[]
...
slink:XrHandMeshMSFT using the
slink:XrSystemHandTrackingMeshPropertiesMSFT::pname:maxHandMeshIndexCount
and
slink:XrSystemHandTrackingMeshPropertiesMSFT::pname:maxHandMeshVertexCount
from the slink:XrSystemHandTrackingMeshPropertiesMSFT returned from the
...
The application should use slink:XrHandMeshMSFT::pname:indexBufferChanged
and slink:XrHandMeshMSFT::pname:vertexBufferChanged in slink:XrHandMeshMSFT
to detect changes and avoid unnecessary data processing when there is no
changes.

include::{generated}/validity/protos/xrUpdateHandMeshMSFT.adoc[]
--
...
include::{generated}/api/structs/XrHandMeshUpdateInfoMSFT.adoc[]
...
all, it must: set slink:XrHandMeshMSFT::pname:isActive to ename:XR_FALSE for
the call to flink:xrUpdateHandMeshMSFT.
Otherwise, if the runtime returns slink:XrHandMeshMSFT::pname:isActive as
ename:XR_TRUE, the data in slink:XrHandMeshMSFT must be valid to use.
...
include::{generated}/validity/structs/XrHandMeshUpdateInfoMSFT.adoc[]
--
...
include::{generated}/api/structs/XrHandMeshMSFT.adoc[]
...
the latest data of the slink:XrHandMeshUpdateInfoMSFT::pname:time given to
the flink:xrUpdateHandMeshMSFT function.
...
include::{generated}/validity/structs/XrHandMeshMSFT.adoc[]
--
...
include::{generated}/api/structs/XrHandMeshIndexBufferMSFT.adoc[]
...
return ename:XR_FALSE for slink:XrHandMeshMSFT::pname:indexBufferChanged
indicating the indices are not changed; or return a new non-zero
pname:indexBufferKey and fill in latest data in pname:indexCountOutput and
pname:indices, and return ename:XR_TRUE for
slink:XrHandMeshMSFT::pname:indexBufferChanged indicating the indices are
...
include::{generated}/validity/structs/XrHandMeshIndexBufferMSFT.adoc[]
--
...
include::{generated}/api/structs/XrHandMeshVertexBufferMSFT.adoc[]
...
and return ename:XR_FALSE for
slink:XrHandMeshMSFT::pname:vertexBufferChanged indicating the vertices are
not changed; or return a new non-zero pname:vertexUpdateTime and fill in
latest data in pname:vertexCountOutput and pname:vertices and return
ename:XR_TRUE for slink:XrHandMeshMSFT::pname:vertexBufferChanged indicating
...
include::{generated}/validity/structs/XrHandMeshVertexBufferMSFT.adoc[]
--
...
include::{generated}/api/structs/XrHandMeshVertexMSFT.adoc[]
...
include::{generated}/validity/structs/XrHandMeshVertexMSFT.adoc[]
--
...
XrSystemHandTrackingMeshPropertiesMSFT handMeshSystemProperties {
    .type = XR_TYPE_SYSTEM_HAND_TRACKING_MESH_PROPERTIES_MSFT,
};
XrSystemProperties systemProperties {
    .type = XR_TYPE_SYSTEM_PROPERTIES,
    .next = &handMeshSystemProperties,
};
...
XrSpace leftHandMeshSpace{};
{
    XrHandMeshSpaceCreateInfoMSFT createInfo {
        ...
        .poseInHandMeshSpace = {{0, 0, 0, 1}, {0, 0, 0}},
    };
...
XrHandMeshMSFT leftHandMesh {
    .type = XR_TYPE_HAND_MESH_MSFT,
    .indexBuffer = {
        .indexCapacityInput = (uint32_t)handMeshIndices.size(),
        .indices = handMeshIndices.data(),
    },
    .vertexBuffer = {
        .vertexCapacityInput = (uint32_t)handMeshVertices.size(),
        .vertices = handMeshVertices.data(),
    },
};
...
include::{generated}/api/structs/XrHandPoseTypeInfoMSFT.adoc[]
...
include::{generated}/validity/structs/XrHandPoseTypeInfoMSFT.adoc[]
--
...
include::{generated}/api/enums/XrHandPoseTypeMSFT.adoc[]
...
while(1){
    ...
    XrHandMeshUpdateInfoMSFT updateInfo {
        .type = XR_TYPE_HAND_MESH_UPDATE_INFO_MSFT,
        .time = time,
        .handPoseType = XR_HAND_POSE_TYPE_REFERENCE_OPEN_PALM_MSFT,
    };
    ...
    if (referenceHandMesh.indexBufferChanged || referenceHandMesh.vertexBufferChanged) {
        ...
        XrHandPoseTypeInfoMSFT handPoseTypeInfo {
        ...
        XrHandTrackerCreateInfoEXT createInfo {
            .type = XR_TYPE_HAND_TRACKER_CREATE_INFO_EXT,
            .next = &handPoseTypeInfo,
            .hand = XR_HAND_LEFT_EXT,
            .handJointSet = XR_HAND_JOINT_SET_DEFAULT_EXT,
        };

        XrHandTrackerEXT referenceHandTracker {XR_NULL_HANDLE};
        CHK_XR(pfnCreateHandTrackerEXT(session, &createInfo, &referenceHandTracker));

        XrHandJointsLocateInfoEXT locateInfo {
            .type = XR_TYPE_HAND_JOINTS_LOCATE_INFO_EXT,
            .next = &handPoseTypeInfo,
            .baseSpace = handMeshReferenceSpace,  // Query joint location relative to hand mesh reference space
            .time = time,
        };
