...
[open,refpage='xrCreateSpatialAnchorFromPerceptionAnchorMSFT',type='protos',desc='Create a slink:XrSpatialAnchorMSFT from a Windows SpatialAnchor pointer',xrefs='']
--
...
[open,refpage='xrTryGetPerceptionAnchorFromSpatialAnchorMSFT',type='protos',desc='Convert a slink:XrSpatialAnchorMSFT to a Windows SpatialAnchor',xrefs='']
--
