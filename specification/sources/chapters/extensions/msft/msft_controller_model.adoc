...
include::{generated}/api/protos/xrGetControllerModelKeyMSFT.adoc[]
...
include::{generated}/validity/protos/xrGetControllerModelKeyMSFT.adoc[]
--
...
include::{generated}/api/structs/XrControllerModelKeyStateMSFT.adoc[]
...
The returned pname:modelKey value depends on an active action binding to the
corresponding subpathname:/grip/pose of the controller.
Therefore, the application must: have provided a valid action set containing
an action for subpathname:/grip/pose, and have successfully completed an
flink:xrSyncActions call, in order to obtain a valid pname:modelKey.

include::{generated}/validity/structs/XrControllerModelKeyStateMSFT.adoc[]
--
...
--
include::{generated}/api/defines/XR_NULL_CONTROLLER_MODEL_KEY_MSFT.adoc[]
...
--
include::{generated}/api/basetypes/XrControllerModelKeyMSFT.adoc[]
...
include::{generated}/api/protos/xrLoadControllerModelMSFT.adoc[]
...
include::{generated}/validity/protos/xrLoadControllerModelMSFT.adoc[]
--
...
include::{generated}/api/protos/xrGetControllerModelPropertiesMSFT.adoc[]
...
include::{generated}/validity/protos/xrGetControllerModelPropertiesMSFT.adoc[]
--
...
include::{generated}/api/structs/XrControllerModelPropertiesMSFT.adoc[]
...
* See the <<fundamentals-buffer-size-parameters>> section for a detailed
  description of retrieving the required pname:nodeProperties size.
****

include::{generated}/validity/structs/XrControllerModelPropertiesMSFT.adoc[]
--
...
include::{generated}/api/structs/XrControllerModelNodePropertiesMSFT.adoc[]
...
The runtime must: not return any pname:nodeName or pname:parentNodeName that
does not match any glTF nodes in the corresponding controller model.

include::{generated}/validity/structs/XrControllerModelNodePropertiesMSFT.adoc[]
--
...
include::{generated}/api/protos/xrGetControllerModelStateMSFT.adoc[]
...
* pname:modelKey is the model key corresponding to the controller model
  being queried.
* pname:state is a pointer to slink:XrControllerModelStateMSFT and returns
...
include::{generated}/validity/protos/xrGetControllerModelStateMSFT.adoc[]
--
...
include::{generated}/api/structs/XrControllerModelStateMSFT.adoc[]
...
* pname:nodeStates is a pointer to an application-allocated array that will
  ...
  It can: be code:NULL if pname:nodeCapacityInput is 0.
* See the <<fundamentals-buffer-size-parameters>> section for a detailed
  description of retrieving the required pname:nodeStates size.
****

include::{generated}/validity/structs/XrControllerModelStateMSFT.adoc[]
--
...
include::{generated}/api/structs/XrControllerModelNodeStateMSFT.adoc[]
...
slink:XrControllerModelNodePropertiesMSFT::pname:nodeName and
slink:XrControllerModelNodePropertiesMSFT::pname:parentNodeName of the node
property at the same array index in the
slink:XrControllerModelPropertiesMSFT::pname:nodeProperties in
...
include::{generated}/validity/structs/XrControllerModelNodeStateMSFT.adoc[]
--
