...
include::../metadata/XR_HTC_facial_tracking.adoc[]
...
include::{INCS-VAR}/api/structs/XrSystemFacialTrackingPropertiesHTC.txt[]
...
include::{INCS-VAR}/validity/structs/XrSystemFacialTrackingPropertiesHTC.txt[]
...
include::{INCS-VAR}/api/handles/XrFacialTrackerHTC.txt[]
...
include::{INCS-VAR}/api/protos/xrCreateFacialTrackerHTC.txt[]
...
include::{INCS-VAR}/validity/protos/xrCreateFacialTrackerHTC.txt[]
...
include::{INCS-VAR}/api/structs/XrFacialTrackerCreateInfoHTC.txt[]
...
include::{INCS-VAR}/validity/structs/XrFacialTrackerCreateInfoHTC.txt[]
--
...
include::{INCS-VAR}/api/enums/XrFacialTrackingTypeHTC.txt[]

include::{INCS-VAR}/api/enums/XrFacialTrackingTypeHTC.comments-box.txt[]
--
...
include::{INCS-VAR}/api/protos/xrDestroyFacialTrackerHTC.txt[]
...
include::{INCS-VAR}/validity/protos/xrDestroyFacialTrackerHTC.txt[]
--
...
include::{INCS-VAR}/api/protos/xrGetFacialExpressionsHTC.txt[]
...
include::{INCS-VAR}/validity/protos/xrGetFacialExpressionsHTC.txt[]
--
...
ename:XR_EYE_EXPRESSION_LEFT_BLINK_HTC value is 100.
|====
...
The blend shape closes eye tightly and at that time
ename:XR_EYE_EXPRESSION_RIGHT_BLINK_HTC value is 100.
|====
