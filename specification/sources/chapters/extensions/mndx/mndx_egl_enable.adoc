...
* pname:getProcAddress is a valid function poiner to sname:eglGetProcAddress.
...
pointer to an slink:XrGraphicsBindingEGLMNDX structure in the pname:next chain
