...
XrSystemProperties systemProperties {
    ...
    .next = &systemFacialExpressionClientProperties,
};
...
PFN_xrCreateFacialExpressionClientML pfnCreateFacialExpressionClientML = nullptr;
...
PFN_xrGetFacialExpressionBlendShapePropertiesML pfnGetFacialExpressionBlendShapesML = nullptr;
...
while (1) {
    ...
    XrFacialExpressionBlendShapeGetInfoML expressionInfo {
