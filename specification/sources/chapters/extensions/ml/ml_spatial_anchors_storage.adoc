...
XrSpatialAnchorsCreateStorageInfoML storageCreateInfo {
...
XrSpatialAnchorsPublishInfoML publishInfo {
    ...
    .anchorCount = static_cast<uint32_t>(anchors.size()),
...
XrSpatialAnchorsPublishCompletionML completion {
    ...
    .uuidCount = static_cast<uint32_t>(uuids.size()),
    .uuids = uuids.data(),
};
...
XrSpatialAnchorsQueryInfoRadiusML queryInfo {
    ...
    .baseSpace = viewSpace, // using viewspace, but can: be any space.
    .center = center,
    .time = currentTime,
    .radius = 10.0f,
};
