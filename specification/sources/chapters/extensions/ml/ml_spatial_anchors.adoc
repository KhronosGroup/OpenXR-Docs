...
PFN_xrCreateSpatialAnchorsAsyncML xrCreateSpatialAnchorsAsyncML = nullptr;
...
PFN_xrCreateSpatialAnchorsCompleteML xrCreateSpatialAnchorsCompleteML = nullptr;
...
XrSpatialAnchorsCreateInfoFromPoseML createInfo {
    .type = XR_TYPE_SPATIAL_ANCHORS_CREATE_INFO_FROM_POSE_ML,
    .baseSpace = baseSpace,
    .poseInBaseSpace = pose,
    .time = time,
};
