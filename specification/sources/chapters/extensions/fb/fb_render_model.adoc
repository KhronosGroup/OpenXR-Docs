...
include::../metadata/XR_FB_render_model.adoc[]
...
include::{INCS-VAR}/api/enums/XrRenderModelFlagBitsFB.comments.txt[]
...
include::{INCS-VAR}/api/structs/XrRenderModelCapabilitiesRequestFB.txt[]
...
include::{INCS-VAR}/validity/structs/XrRenderModelCapabilitiesRequestFB.txt[]
--
