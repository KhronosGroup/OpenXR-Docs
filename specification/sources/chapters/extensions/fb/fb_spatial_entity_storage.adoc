...
include::../metadata/XR_FB_spatial_entity_storage.adoc[]
...
--
include::{INCS-VAR}/api/enums/XrSpaceStorageLocationFB.txt[]
...
include::{INCS-VAR}/api/enums/XrSpaceStorageLocationFB.comments-box.txt[]
--

[open,refpage='XrSpacePersistenceModeFB',desc='Persistence mode',type='enums']
--
include::{INCS-VAR}/api/enums/XrSpacePersistenceModeFB.txt[]

The elink:XrSpacePersistenceModeFB enumeration specifies the persistence
mode for the save operation.

include::{INCS-VAR}/api/enums/XrSpacePersistenceModeFB.comments-box.txt[]
--
...
include::{INCS-VAR}/api/structs/XrSpaceSaveInfoFB.txt[]
...
* pname:space is the slink:XrSpace handle to the reference space that
  defines the pname:poseInSpace of the entity to be saved.
...
include::{INCS-VAR}/validity/structs/XrSpaceSaveInfoFB.txt[]
--
...
include::{INCS-VAR}/api/structs/XrSpaceEraseInfoFB.txt[]
...
include::{INCS-VAR}/validity/structs/XrSpaceEraseInfoFB.txt[]
--

[open,refpage='XrEventDataSpaceSaveCompleteFB',type='structs',desc='Describes the result of a save operation',xrefs='']
--
The slink:XrEventDataSpaceSaveCompleteFB structure is defined as:

include::{INCS-VAR}/api/structs/XrEventDataSpaceSaveCompleteFB.txt[]
...
include::{INCS-VAR}/validity/structs/XrEventDataSpaceSaveCompleteFB.txt[]
--

[open,refpage='XrEventDataSpaceEraseCompleteFB',type='structs',desc='Describes the result of a save operation',xrefs='']
--
The slink:XrEventDataSpaceEraseCompleteFB structure is defined as:

include::{INCS-VAR}/api/structs/XrEventDataSpaceEraseCompleteFB.txt[]
...
include::{INCS-VAR}/validity/structs/XrEventDataSpaceEraseCompleteFB.txt[]
--
...
include::{INCS-VAR}/api/protos/xrSaveSpaceFB.txt[]
...
include::{INCS-VAR}/validity/protos/xrSaveSpaceFB.txt[]
--
...
include::{INCS-VAR}/api/protos/xrEraseSpaceFB.txt[]
...
include::{INCS-VAR}/validity/protos/xrEraseSpaceFB.txt[]
--
