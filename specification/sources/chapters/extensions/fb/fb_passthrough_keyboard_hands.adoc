...
include::../meta/XR_FB_passthrough_keyboard_hands.adoc[]
...
* Setting the level of intensity for the hand mask in a passthrough layer
  ...
  ename:XR_PASSTHROUGH_LAYER_PURPOSE_TRACKED_KEYBOARD_HANDS_FB
...
* ename:XR_PASSTHROUGH_LAYER_PURPOSE_TRACKED_KEYBOARD_HANDS_FB - It defines
  a keyboard hands presence purpose of passthrough layer.
