...
include::../metadata/XR_FB_composition_layer_settings.adoc[]
...
--
include::{INCS-VAR}/api/flags/XrCompositionLayerSettingsFlagsFB.txt[]
--
...
--
include::{INCS-VAR}/api/enums/XrCompositionLayerSettingsFlagBitsFB.txt[]

include::{INCS-VAR}/api/enums/XrCompositionLayerSettingsFlagBitsFB.comments.txt[]
--
...
include::{INCS-VAR}/api/structs/XrCompositionLayerSettingsFB.txt[]
...
include::{INCS-VAR}/validity/structs/XrCompositionLayerSettingsFB.txt[]
--
