...
[open,refpage='XrSystemEyeTrackingPropertiesFB',type='structs',desc='System property for eye tracking',xrefs='XrSystemProperties']
--
...
PFN_xrCreateEyeTrackerFB pfnCreateEyeTrackerFB = nullptr;
...
PFN_xrGetEyeGazesFB pfnGetEyeGazesFB = nullptr;
