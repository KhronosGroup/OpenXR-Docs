...
[open,refpage='XrSystemFaceTrackingPropertiesFB',type='structs',desc='System property for face tracking',xrefs='XrSystemProperties']
--
...
PFN_xrCreateFaceTrackerFB pfnCreateFaceTrackerFB = nullptr;
...
XrFaceTrackerFB faceTracker{XR_NULL_HANDLE};
{
    XrFaceTrackerCreateInfoFB createInfo{
        .type = XR_TYPE_FACE_TRACKER_CREATE_INFO_FB,
        .next = nullptr,
        .faceExpressionSet = XR_FACE_EXPRESSION_SET_DEFAULT_FB,
    };
...
PFN_xrGetFaceExpressionWeightsFB pfnGetFaceExpressionWeights = nullptr;
