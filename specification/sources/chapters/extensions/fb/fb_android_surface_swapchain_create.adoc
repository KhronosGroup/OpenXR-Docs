include::../meta/XR_FB_android_surface_swapchain_create.adoc[]
...
To specify the additional create flags, you must create a
slink:XrAndroidSurfaceSwapchainCreateInfoFB structure and pass it on the
call to flink:xrCreateSwapchainAndroidSurfaceKHR via the
slink:XrSwapchainCreateInfo structure's pname:next parameter.
