...
include::../metadata/XR_FB_passthrough.adoc[]
...
include::{INCS-VAR}/api/structs/XrPassthroughBrightnessContrastSaturationFB.txt[]
...
include::{INCS-VAR}/validity/structs/XrPassthroughBrightnessContrastSaturationFB.txt[]
--
