...
See xref:XR_META_colocation_discovery-discovery-normal[xrefstyle=short] and
xref:XR_META_colocation_discovery-discovery-runtime-stop[xrefstyle=short]
for sample flows incorporating use of flink:xrStartColocationDiscoveryMETA.
...
xref:XR_META_colocation_discovery-discovery-runtime-stop[xrefstyle=short]
for sample flows that show how
slink:XrEventDataColocationDiscoveryResultMETA is used.
...
xref:XR_META_colocation_discovery-discovery-runtime-stop[xrefstyle=short]
for sample flows that show how
slink:XrEventDataColocationDiscoveryCompleteMETA is used.
