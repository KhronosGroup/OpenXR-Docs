...
include::../metadata/XR_META_performance_metrics.adoc[]
...
basetype:XrPath, under the root path pathname:/perfmetrics_meta.
You can: query the available counters through
...
After a session is created, you can: use
flink:xrSetPerformanceMetricsStateMETA to enable the performance metrics
system for that session.
You can: use flink:xrQueryPerformanceMetricsCounterMETA to query performance
metrics counter on a session that has performance metrics system enabled, or
use flink:xrGetPerformanceMetricsStateMETA to get the enablement state.
...
--
include::{INCS-VAR}/api/flags/XrPerformanceMetricsCounterFlagsMETA.txt[]
--
...
--
include::{INCS-VAR}/api/enums/XrPerformanceMetricsCounterFlagBitsMETA.txt[]
include::{INCS-VAR}/api/enums/XrPerformanceMetricsCounterFlagBitsMETA.comments.txt[]
--
...
--
include::{INCS-VAR}/api/enums/XrPerformanceMetricsCounterUnitMETA.txt[]
include::{INCS-VAR}/api/enums/XrPerformanceMetricsCounterUnitMETA.comments.txt[]
--

*New Structures*

[open,refpage='XrPerformanceMetricsStateMETA',type='structs',desc='Performance metrics enablement state',xrefs='']
--

The slink:XrPerformanceMetricsStateMETA structure is defined as:

include::{INCS-VAR}/api/structs/XrPerformanceMetricsStateMETA.txt[]
...
calling flink:xrGetPerformanceMetricsStateMETA to query the enablement
status of the performance metrics system.

include::{INCS-VAR}/validity/structs/XrPerformanceMetricsStateMETA.txt[]
--
...
include::{INCS-VAR}/api/structs/XrPerformanceMetricsCounterMETA.txt[]
...
include::{INCS-VAR}/validity/structs/XrPerformanceMetricsCounterMETA.txt[]
--
...
--
The flink:xrEnumeratePerformanceMetricsCounterPathsMETA function enumerate
all performance metrics counter paths that supported by the runtime, it is
defined as:

include::{INCS-VAR}/api/protos/xrEnumeratePerformanceMetricsCounterPathsMETA.txt[]
...
* pname:counterPathCountOutput is filled in by the runtime with the count of
  ...
  pname:counterPathCapacityInput is 0.
...
include::{INCS-VAR}/validity/protos/xrEnumeratePerformanceMetricsCounterPathsMETA.txt[]
--
...
include::{INCS-VAR}/api/protos/xrSetPerformanceMetricsStateMETA.txt[]
...
include::{INCS-VAR}/validity/protos/xrSetPerformanceMetricsStateMETA.txt[]
--
...
include::{INCS-VAR}/api/protos/xrGetPerformanceMetricsStateMETA.txt[]
...
include::{INCS-VAR}/validity/protos/xrGetPerformanceMetricsStateMETA.txt[]
--
...
include::{INCS-VAR}/api/protos/xrQueryPerformanceMetricsCounterMETA.txt[]
...
include::{INCS-VAR}/validity/protos/xrQueryPerformanceMetricsCounterMETA.txt[]
--
