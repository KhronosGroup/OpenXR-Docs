...
include::../metadata/XR_META_vulkan_swapchain_create_info.adoc[]
...
--
include::{INCS-VAR}/api/structs/XrVulkanSwapchainCreateInfoMETA.txt[]
...
include::{INCS-VAR}/validity/structs/XrVulkanSwapchainCreateInfoMETA.txt[]
--
