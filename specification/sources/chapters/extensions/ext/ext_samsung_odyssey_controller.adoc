...
include::../meta/XR_EXT_samsung_odyssey_controller.adoc[]
...
pathname:/interaction_profile/samsung/odyssey_controller to describe the
Odyssey controller.
...
pathname:/interaction_profile/microsoft/motion_controller>> in terms of
