...
include::{generated}/api/structs/XrSystemPlaneDetectionPropertiesEXT.txt[]
...
include::{generated}/validity/structs/XrSystemPlaneDetectionPropertiesEXT.txt[]
--
...
include::{generated}/api/flags/XrPlaneDetectionCapabilityFlagsEXT.txt[]
--
...
include::{generated}/api/enums/XrPlaneDetectionCapabilityFlagBitsEXT.txt[]

The flag bits have the following meanings:

include::{generated}/api/enums/XrPlaneDetectionCapabilityFlagBitsEXT.comments.txt[]
...
--
include::{generated}/api/handles/XrPlaneDetectorEXT.txt[]
...
include::{generated}/api/protos/xrCreatePlaneDetectorEXT.txt[]
...
include::{generated}/validity/protos/xrCreatePlaneDetectorEXT.txt[]
--
...
include::{generated}/api/structs/XrPlaneDetectorCreateInfoEXT.txt[]
...
include::{generated}/validity/structs/XrPlaneDetectorCreateInfoEXT.txt[]
--
...
include::{generated}/api/flags/XrPlaneDetectorFlagsEXT.txt[]
--
...
include::{generated}/api/enums/XrPlaneDetectorFlagBitsEXT.txt[]

The flag bits have the following meanings:

include::{generated}/api/enums/XrPlaneDetectorFlagBitsEXT.comments.txt[]
--
...
include::{generated}/api/protos/xrDestroyPlaneDetectorEXT.txt[]
...
include::{generated}/validity/protos/xrDestroyPlaneDetectorEXT.txt[]
--
...
include::{generated}/api/protos/xrBeginPlaneDetectionEXT.txt[]
...
The runtime must: resolve the location defined by pname:baseSpace at the
time of the call.
...
pname:baseSpace is not locatable at the time of the call.

include::{generated}/validity/protos/xrBeginPlaneDetectionEXT.txt[]
--
...
include::{generated}/api/structs/XrPlaneDetectorBeginInfoEXT.txt[]
...
* pname:next is code:NULL or a pointer to the next structure in a structure
  chain.
  No such structures are defined in core OpenXR or this extension.
* pname:baseSpace is the slink:XrSpace that the pname:boundingBox is defined
  in.
...
include::{generated}/validity/structs/XrPlaneDetectorBeginInfoEXT.txt[]
--
...
include::{generated}/api/protos/xrGetPlaneDetectionStateEXT.txt[]
...
include::{generated}/validity/protos/xrGetPlaneDetectionStateEXT.txt[]
--
...
include::{generated}/api/protos/xrGetPlaneDetectionsEXT.txt[]
...
include::{generated}/validity/protos/xrGetPlaneDetectionsEXT.txt[]
--
...
include::{generated}/api/structs/XrPlaneDetectorGetInfoEXT.txt[]
...
include::{generated}/validity/structs/XrPlaneDetectorGetInfoEXT.txt[]
--
...
include::{generated}/api/structs/XrPlaneDetectorLocationsEXT.txt[]
...
* pname:planeLocationCountOutput is the number of planes, or the required
  capacity in the case that pname:planeCapacityInput is insufficient.
* pname:planeLocations is an array of slink:XrPlaneDetectorLocationEXT.
  It can: be code:NULL if pname:planeCapacityInput is 0.
* See <<buffer-size-parameters, Buffer Size Parameters>> chapter for a
  detailed description of retrieving the required pname:planeLocations size.
****

include::{generated}/validity/structs/XrPlaneDetectorLocationsEXT.txt[]
--
...
include::{generated}/api/structs/XrPlaneDetectorLocationEXT.txt[]
...
* pname:extent is the extent of the plane along the x-axis (width) and
  z-axis (height) centered on the pname:pose.
...
include::{generated}/validity/structs/XrPlaneDetectorLocationEXT.txt[]
--
...
include::{generated}/api/enums/XrPlaneDetectorOrientationEXT.txt[]

The enums have the following meanings:

include::{generated}/api/enums/XrPlaneDetectorOrientationEXT.comments.txt[]
--
...
include::{generated}/api/enums/XrPlaneDetectorSemanticTypeEXT.txt[]

The enums have the following meanings:

include::{generated}/api/enums/XrPlaneDetectorSemanticTypeEXT.comments.txt[]
--
...
include::{generated}/api/enums/XrPlaneDetectionStateEXT.txt[]
...
include::{generated}/api/protos/xrGetPlanePolygonBufferEXT.txt[]
...
include::{generated}/validity/protos/xrGetPlanePolygonBufferEXT.txt[]
--
...
include::{generated}/api/structs/XrPlaneDetectorPolygonBufferEXT.txt[]
...
include::{generated}/validity/structs/XrPlaneDetectorPolygonBufferEXT.txt[]
--
...
include::{generated}/api/structs/XrExtent3DfEXT.txt[]
