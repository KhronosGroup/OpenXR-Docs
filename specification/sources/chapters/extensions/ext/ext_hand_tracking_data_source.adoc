...
include::{generated}/api/enums/XrHandTrackingDataSourceEXT.txt[]
...
include::{generated}/api/structs/XrHandTrackingDataSourceInfoEXT.txt[]
...
include::{generated}/validity/structs/XrHandTrackingDataSourceInfoEXT.txt[]
--
...
include::{generated}/api/structs/XrHandTrackingDataSourceStateEXT.txt[]
...
pname:requestedDataSources, the runtime must: set pname:isActive to
ename:XR_TRUE.
...
pname:requestedDataSources when creating the corresponding hand tracker.

include::{generated}/validity/structs/XrHandTrackingDataSourceStateEXT.txt[]
--
...
+
The pname:isActive member of slink:XrHandTrackingDataSourceInfoEXT allows
the runtime to describe if the tracking device is active.
slink:XrHandTrackingDataSourceInfoEXT::pname:isActive describes if the
