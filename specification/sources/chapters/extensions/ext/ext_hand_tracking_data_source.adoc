...
==== Specifying Acceptable Data Source at Creation
...
include::{generated}/interfaces/XR_EXT_hand_tracking_data_source.adoc[leveloffset=1]
...
slink:XrHandJointLocationsEXT::pname:isActive describes if the tracking
device is actively tracking.
