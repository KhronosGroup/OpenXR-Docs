...
source on the input device for a known
<<semantic-paths-interaction-profiles, interaction profile>>, but runtimes
have the ability to choose a different control depending on user preference,
...
XrActionSet inGameActionSet {XR_NULL_HANDLE};
...
XrActionCreateInfo hapticsactioninfo {
    .type = XR_TYPE_ACTION_CREATE_INFO,
    .actionName = "player_hit",
    .actionType = XR_ACTION_TYPE_VIBRATION_OUTPUT,
    .localizedActionName = "Player hit",
};
XrAction hapticsAction {XR_NULL_HANDLE};
CHK_XR(xrCreateAction(inGameActionSet, &hapticsactioninfo, &hapticsAction));

XrPath triggerClickPath {XR_NULL_PATH}, hapticPath {XR_NULL_PATH};
...
--
include::{generated}/api/handles/XrActionSet.adoc[]
...
Enabled action sets are indicated by the application via flink:xrSyncActions
depending on the current application context.

For example, consider using one collection of actions that apply to
controlling a character and another collection for navigating a menu system.
When these actions are structured as two slink:XrActionSet handles, the
applicable action set is easy to specify according to application logic
using a single function call.

Further, suppose some actions only apply when operating a vehicle as a
character.
This is intended to be modeled as another separate action set.
While the user is operating a vehicle, the application enables both the
character-control and vehicle action sets simultaneously in each
flink:xrSyncActions call.
...
include::{generated}/api/protos/xrCreateActionSet.adoc[]
...
include::{generated}/validity/protos/xrCreateActionSet.adoc[]
--
...
include::{generated}/api/structs/XrActionSetCreateInfo.adoc[]
...
the same <<semantic-paths-input, identifier and optional location>> path
...
That means the `isActive` field must: be ename:XR_FALSE when retrieving
...
level of a <<semantic-paths-well-formed, well-formed path string>>, the
runtime must: return ename:XR_ERROR_PATH_FORMAT_INVALID.

include::{generated}/validity/structs/XrActionSetCreateInfo.adoc[]
--
...
include::{generated}/api/protos/xrDestroyActionSet.adoc[]
...
include::{generated}/validity/protos/xrDestroyActionSet.adoc[]
--

[[input-creating-actions]]
=== Creating Actions

[open,refpage='XrAction',desc='Opaque handle to an action',type='handles',xrefs='xrCreateAction xrDestroyAction XrActionType']
--
include::{generated}/api/handles/XrAction.adoc[]
...
include::{generated}/api/protos/xrCreateAction.adoc[]
...
include::{generated}/validity/protos/xrCreateAction.adoc[]
--
...
include::{generated}/api/structs/XrActionCreateInfo.adoc[]
...
include::{generated}/validity/structs/XrActionCreateInfo.adoc[]
--
...
include::{generated}/api/enums/XrActionType.adoc[]
...
include::{generated}/api/protos/xrDestroyAction.adoc[]
...
include::{generated}/validity/protos/xrDestroyAction.adoc[]
--
...
<<semantic-paths-interaction-profiles, interaction profile>> that the
...
If the path refers to the parent of input values instead of to an input
value itself, the runtime must: use subpathname:/example/path/value instead
of subpathname:/example/path as the source of the value.
...
include::{generated}/api/protos/xrSuggestInteractionProfileBindings.adoc[]
...
The flink:xrSuggestInteractionProfileBindings function provides action
...
<<semantic-paths-interaction-profiles, Interaction Profiles>> or suggested
bindings contain paths that do not follow the format defined in
<<semantic-paths-input>> (further described in
slink:XrActionSuggestedBinding), the runtime must: return
ename:XR_ERROR_PATH_UNSUPPORTED.
If the interaction profile path or binding path (top level pathname:/user
path plus input subpath) for any of the suggested bindings does not exist in
the allowlist defined in <<semantic-paths-interaction-profiles, Interaction
Profile Paths>>, the runtime must: return ename:XR_ERROR_PATH_UNSUPPORTED.
...
include::{generated}/validity/protos/xrSuggestInteractionProfileBindings.adoc[]
--
...
include::{generated}/api/structs/XrInteractionProfileSuggestedBinding.adoc[]
...
include::{generated}/validity/structs/XrInteractionProfileSuggestedBinding.adoc[]
--
...
include::{generated}/api/structs/XrActionSuggestedBinding.adoc[]
...
* pname:binding is the basetype:XrPath of a binding for the action specified
  in pname:action.
  This "binding path" is any top level pathname:/user path plus an
  applicable <<semantic-paths-input,input subpath>>, for example
  pathname:/user/hand/right/input/trigger/click.
  See <<input-suggested-bindings>> for more details.
****

include::{generated}/validity/structs/XrActionSuggestedBinding.adoc[]
--
...
include::{generated}/api/protos/xrAttachSessionActionSets.adoc[]
...
slink:XrSessionActionSetsAttachInfo::pname:actionSets to the pname:session.
...
include::{generated}/validity/protos/xrAttachSessionActionSets.adoc[]
--
...
include::{generated}/api/structs/XrSessionActionSetsAttachInfo.adoc[]
...
include::{generated}/validity/structs/XrSessionActionSetsAttachInfo.adoc[]
--

[[input-current-interaction-profile]]
...
include::{generated}/api/protos/xrGetCurrentInteractionProfile.adoc[]
...
flink:xrGetCurrentInteractionProfile retrieves the current interaction
profile for a top level user path.

The runtime must: return only interaction profiles for which the application
has provided suggested bindings with
flink:xrSuggestInteractionProfileBindings or dlink:XR_NULL_PATH.
...
of.
The runtime may: return an anticipated interaction profile, from the list of
interaction profiles with suggested bindings (as supplied by the application
through flink:xrSuggestInteractionProfileBindings) for this top level
pathname:/user path, in the event that no controllers are active.
Whether the runtime reports an interaction profile path or
dlink:XR_NULL_PATH does *not* provide any signal to the application
regarding presence or absence of a controller or other interaction method.
...
If pname:topLevelUserPath is not one of the top level user paths described
in <<semantic-paths-user>>, the runtime must: return
ename:XR_ERROR_PATH_UNSUPPORTED.

include::{generated}/validity/protos/xrGetCurrentInteractionProfile.adoc[]
--
...
include::{generated}/api/structs/XrInteractionProfileState.adoc[]
...
* pname:interactionProfile is the basetype:XrPath of the interaction profile
  path for the flink:xrGetCurrentInteractionProfile::pname:topLevelUserPath
  used to retrieve this state, or dlink:XR_NULL_PATH if there is no active
...
include::{generated}/validity/structs/XrInteractionProfileState.adoc[]
--


[open,refpage='XrEventDataInteractionProfileChanged',desc='Notifies the application than the active interaction profile has changed',type='structs',xrefs='xrSuggestInteractionProfileBindings xrGetCurrentInteractionProfile xrPollEvent XrEventDataBuffer XrEventDataBaseHeader']
--

The slink:XrEventDataInteractionProfileChanged structure is defined as:
include::{generated}/api/structs/XrEventDataInteractionProfileChanged.adoc[]
...
The slink:XrEventDataInteractionProfileChanged event is queued to notify the
application that the current interaction profile for one or more top level
user paths has changed.
...
Upon receiving this event, an application can: call
flink:xrGetCurrentInteractionProfile for each top level user path in use, if
its behavior depends on the current interaction profile.

include::{generated}/validity/structs/XrEventDataInteractionProfileChanged.adoc[]
--

[[input-reading-input-action-state]]
...
session <<XR_SESSION_STATE_FOCUSED, is not focused>>, the runtime must: set
the pname:isActive value to ename:XR_FALSE and suppress all haptic output.
...
It is defined as:
include::{generated}/api/structs/XrActionStateGetInfo.adoc[]
...
include::{generated}/validity/structs/XrActionStateGetInfo.adoc[]
--
...
It is defined as:
include::{generated}/api/structs/XrHapticActionInfo.adoc[]
...
include::{generated}/validity/structs/XrHapticActionInfo.adoc[]
--
...
include::{generated}/api/protos/xrGetActionStateBoolean.adoc[]
...
include::{generated}/validity/protos/xrGetActionStateBoolean.adoc[]
--
...
include::{generated}/api/structs/XrActionStateBoolean.adoc[]
...
follows <<input-multiple,the previously defined rule to resolve ambiguity>>.

include::{generated}/validity/structs/XrActionStateBoolean.adoc[]
--

[[input-scalar-and-vector-actions]]
...
include::{generated}/api/protos/xrGetActionStateFloat.adoc[]
...
include::{generated}/validity/protos/xrGetActionStateFloat.adoc[]
--
...
include::{generated}/api/structs/XrActionStateFloat.adoc[]
...
include::{generated}/validity/structs/XrActionStateFloat.adoc[]
--
...
include::{generated}/api/protos/xrGetActionStateVector2f.adoc[]
...
include::{generated}/validity/protos/xrGetActionStateVector2f.adoc[]
--
...
include::{generated}/api/structs/XrActionStateVector2f.adoc[]
...
include::{generated}/validity/structs/XrActionStateVector2f.adoc[]
--
...
include::{generated}/api/protos/xrGetActionStatePose.adoc[]
...
include::{generated}/validity/protos/xrGetActionStatePose.adoc[]
--
...
include::{generated}/api/structs/XrActionStatePose.adoc[]
...
<<input-multiple,the previously defined rule>>.

include::{generated}/validity/structs/XrActionStatePose.adoc[]
--

[[input-output-actions-haptics]]
...
include::{generated}/api/protos/xrApplyHapticFeedback.adoc[]
...
include::{generated}/validity/protos/xrApplyHapticFeedback.adoc[]
--
...
include::{generated}/api/structs/XrHapticBaseHeader.adoc[]
...
include::{generated}/validity/structs/XrHapticBaseHeader.adoc[]
--
...
include::{generated}/api/structs/XrHapticVibration.adoc[]
...
include::{generated}/validity/structs/XrHapticVibration.adoc[]
--
...
include::{generated}/api/defines/XR_MIN_HAPTIC_DURATION.adoc[]
--
...
pulse.
include::{generated}/api/defines/XR_FREQUENCY_UNSPECIFIED.adoc[]
--
...
include::{generated}/api/protos/xrStopHapticFeedback.adoc[]
...
include::{generated}/validity/protos/xrStopHapticFeedback.adoc[]
--
...
include::{generated}/api/protos/xrSyncActions.adoc[]
...
slink:XrActionsSyncInfo::pname:activeActionSets must: have been previously
attached to the session via flink:xrAttachSessionActionSets.
...
include::{generated}/validity/protos/xrSyncActions.adoc[]
--
...
include::{generated}/api/structs/XrActionsSyncInfo.adoc[]
...
include::{generated}/validity/structs/XrActionsSyncInfo.adoc[]
--
...
include::{generated}/api/structs/XrActiveActionSet.adoc[]
...
include::{generated}/validity/structs/XrActiveActionSet.adoc[]
--
...
The bound pname:sources are opaque basetype:XrPath values representing the
...
include::{generated}/api/protos/xrEnumerateBoundSourcesForAction.adoc[]
...
* pname:sourceCountOutput is a pointer to the count of pname:sources, or a
  pointer to the required capacity in the case that
  pname:sourceCapacityInput is insufficient.
...
* See the <<fundamentals-buffer-size-parameters>> section for a detailed
  description of retrieving the required pname:sources size.
****
...
include::{generated}/validity/protos/xrEnumerateBoundSourcesForAction.adoc[]
--
...
include::{generated}/api/structs/XrBoundSourcesForActionEnumerateInfo.adoc[]
...
include::{generated}/validity/structs/XrBoundSourcesForActionEnumerateInfo.adoc[]
--
...
include::{generated}/api/protos/xrGetInputSourceLocalizedName.adoc[]
...
* pname:bufferCountOutput is a pointer to the count of name characters
  written to pname:buffer (including the terminating `\0`), or a pointer to
  the required capacity in the case that pname:bufferCapacityInput is
  insufficient.
...
include::{generated}/validity/protos/xrGetInputSourceLocalizedName.adoc[]
--
...
include::{generated}/api/structs/XrInputSourceLocalizedNameGetInfo.adoc[]
...
The result of passing an basetype:XrPath pname:sourcePath *not* retrieved
from flink:xrEnumerateBoundSourcesForAction is not specified.

include::{generated}/validity/structs/XrInputSourceLocalizedNameGetInfo.adoc[]
--
...
--
The slink:XrInputSourceLocalizedNameGetInfo::pname:whichComponents parameter
is of the following type, and contains a bitwise-OR of one or more of the
bits defined in elink:XrInputSourceLocalizedNameFlagBits.

include::{generated}/api/flags/XrInputSourceLocalizedNameFlags.adoc[]
--
...
include::{generated}/api/enums/XrInputSourceLocalizedNameFlagBits.adoc[]
