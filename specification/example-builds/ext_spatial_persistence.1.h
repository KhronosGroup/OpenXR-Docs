...
XrSpatialPersistenceContextEXT persistenceContext;    // previously initialized
...
bool isSpatialCapabilitySupported(XrInstance, XrSystemId, XrSpatialCapabilityEXT) { return false; }
bool isSpatialComponentSupported(XrInstance, XrSystemId, XrSpatialCapabilityEXT, XrSpatialComponentTypeEXT) { return false; }
